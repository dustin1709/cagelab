...
const ViewItem = () => {
  ...
  const url_reserved = "http://192.168.192.31:3000/borrower_item/type/quantityReserved/";
  const url_checkedout = "http://192.168.192.31:3000/borrower_contents/type/quantityCheckedout/";
  ...
  return (
    <>
      ...
      <div className="mainContainerRight">
        ...
        <Link to="/staff/inventory" className="btn btn-primary btn-lg btn-block" style={{padding: '0.5%', marginBottom: '1%'}}>
          Back to Inventory
        </Link>
          {items.map((item) => (<h3>{item.model}</h3>))}
          <h5>Quantity total: {amount}</h5>
          ...
          <div style={{width: "100%", clear: 'both'}}>
            ...
            <form onSubmit={add} style={{
              width: "30%", clear: 'both', padding: '1%', textAlign: 'left'
            }}>
