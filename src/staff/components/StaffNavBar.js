    ...
    return (
        <div className='d-flex flex-column flex-shrink-0 p-3 text-white MyNavBar' style={{backgroundColor: '#F29441'}}>
            ...
            <ul className="nav nav-pills flex-column mb-auto">
                <li>
                    <NavLink to="/staff/dashboard" activeclassname="active" className="nav-link text-white">
                        Dashboard
                    </NavLink>
                </li>
                <li>
                ...
                <li>
                    <NavLink to="/staff/cart" activeclassname="active" className="nav-link text-white">
                        Shopping Cart
                    </NavLink>
                </li>
                <li>
                ...
                <li>
                    <NavLink to="/staff/kit" activeclassname="active" className="nav-link text-white">
                        Kit Request
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/staff/inventory" activeclassname="active" className="nav-link text-white">
                        Inventory
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/staff/report" activeclassname="active" className="nav-link text-white">
                        Report
                    </NavLink>
                </li>
                <li>
